    ...
    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-gray-900">{userStats.totalLessonsCompleted}</p>
                    <p className="text-sm text-gray-600">完了レッスン数</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-2">{userStats.experiencePoints} XP</p>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              {/* AI基礎学部 */}
              <div className="bg-white rounded-lg shadow-sm border border-blue-200 p-6 hover:shadow-md transition-shadow relative overflow-hidden">
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">ChatGPTの基本操作</h4>
                  <p className="text-sm text-gray-600">AI基礎学部 • レッスン3</p>
              ...
              <div className="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="text-2xl mr-4">🎯</div>
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">プロンプトエンジニアリング入門</h4>
                  <p className="text-sm text-gray-600">AI基礎学部 • レッスン2</p>
                  <div className="flex items-center mt-2">
                    <div className="flex items-center text-xs text-green-600 mr-4">
                      <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="text-2xl mr-4">🤖</div>
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">AIとは何か？基本概念の理解</h4>
                  <p className="text-sm text-gray-600">AI基礎学部 • レッスン1</p>
                  <div className="flex items-center mt-2">
                    <div className="flex items-center text-xs text-green-600 mr-4">
                      <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="text-2xl mr-4">📊</div>
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">データ分析でビジネスを改善</h4>
                  <p className="text-sm text-gray-600">AI基礎学部 • 25分</p>
                </div>
              ...
              <div className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="text-2xl mr-4">🚀</div>
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">ChatGPTで作業効率を上げる10のコツ</h4>
                  <p className="text-sm text-gray-600">AI基礎学部 • 15分</p>
                </div>
                <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="text-2xl mr-4">💡</div>
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">AIツールでプレゼン資料作成</h4>
                  <p className="text-sm text-gray-600">AI基礎学部 • 20分</p>
                </div>
                <div className="flex items-center space-x-2">
                  <button className="p-2 text-red-500 hover:bg-red-50 rounded-full">
                    <svg className="w-5 h-5 fill-current" viewBox="0 0 20 20">
              ...
              <div className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="text-2xl mr-4">📈</div>
                <div className="flex-1">
                  <h4 className="font-medium text-gray-900">ビジネスメールをAIで效率化</h4>
                  <p className="text-sm text-gray-600">AI基礎学部 • 18分</p>
                </div>
                <div className="flex items-center space-x-2">
                  <button className="p-2 text-yellow-500 hover:bg-yellow-50 rounded-full">
                    <svg className="w-5 h-5 fill-current" viewBox="0 0 20 20">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-center mb-3">
                  <div className="flex items-center">
                    ...
                    <div>
                      <span className="text-base font-semibold text-gray-900">AI基礎学部</span>
                      <p className="text-sm text-gray-600">基礎コンセプトから実践まで</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <span className="text-lg font-bold text-blue-600">25%</span>
                    <p className="text-xs text-gray-500">3/12 レッスン完了</p>
                  </div>
                </div>
              ...
              <div className="border border-gray-200 rounded-lg p-4 opacity-60">
                <div className="flex justify-between items-center mb-3">
                  <div className="flex items-center">
                    <div className="text-2xl mr-3">⚡</div>
                    <div>
                      <span className="text-base font-semibold text-gray-900">業務効率化学部</span>
                      <p className="text-sm text-gray-600">ExcelやOfficeツールとAIの連携</p>
                    </div>
                  </div>
                  <div className="text-right">
              ...
              <div className="border border-gray-200 rounded-lg p-4 opacity-60">
                <div className="flex justify-between items-center mb-3">
                  <div className="flex items-center">
                    <div className="text-2xl mr-3">🚀</div>
                    <div>
                      <span className="text-base font-semibold text-gray-900">実践応用学部</span>
                      <p className="text-sm text-gray-600">プログラミングとAIの高度な活用</p>
                    </div>
                  </div>
                  <div className="text-right">
