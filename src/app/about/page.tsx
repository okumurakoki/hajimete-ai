...
export default function AboutPage() {
  ...
  return (
    <ContentLayout>
      ...
      {/* チーム紹介 */}
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">チーム紹介</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, index) => (
            <div key={index} className="bg-white rounded-xl border shadow-sm p-6 text-center hover:shadow-md transition-shadow">
          ...
          <div className="space-y-8">
            {milestones.map((milestone, index) => (
              <div key={index} className="flex items-start">
                <div className="flex-shrink-0 w-32 text-blue-600 font-semibold text-sm">
                  {milestone.year}
                </div>
                <div className="flex-1 ml-8">
                  <div className="relative">
                    <div className="absolute -left-6 top-2 w-3 h-3 bg-blue-600 rounded-full"></div>
                    <div className="absolute -left-5.5 top-5 w-0.5 h-16 bg-blue-200 last:hidden"></div>
      ...
      {/* 数字で見るはじめて.AI */}
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">数字で見るはじめて.AI</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-600">学習コース数</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-purple-600 mb-2">95%</div>
            <div className="text-gray-600">受講者満足度</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-600 mb-2">500+</div>
            <div className="text-gray-600">企業導入実績</div>
          </div>
        </div>
      </div>
      ...
      {/* 認定・パートナーシップ */}
      <div className="mb-16">
        <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">認定・パートナーシップ</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl border shadow-sm p-6 text-center">
            <Award className="w-12 h-12 text-gold-500 mx-auto mb-4" />
            <h3 className="text-lg font-semibold text-gray-900 mb-2">ISO 27001認証</h3>
            <p className="text-gray-600 text-sm">情報セキュリティマネジメントシステムの国際規格を取得</p>
          </div>
          <div className="bg-white rounded-xl border shadow-sm p-6 text-center">
            <Shield className="w-12 h-12 text-blue-500 mx-auto mb-4" />
            <h3 className="text-lg font-semibold text-gray-900 mb-2">プライバシーマーク</h3>
            <p className="text-gray-600 text-sm">個人情報保護の適切な取り組みを実施する事業者として認定</p>
          </div>
          <div className="bg-white rounded-xl border shadow-sm p-6 text-center">
            <Globe className="w-12 h-12 text-green-500 mx-auto mb-4" />
            <h3 className="text-lg font-semibold text-gray-900 mb-2">教育機関連携</h3>
            <p className="text-gray-600 text-sm">全国50以上の大学・専門学校と教育コンテンツで連携</p>
          </div>
        </div>
      </div>
