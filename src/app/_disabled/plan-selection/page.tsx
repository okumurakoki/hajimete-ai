...
export default function PlanSelection() {
  ...
  const plans = [
    ...
    },
    {
      ...
      departments: ['AI基礎学部', '業務効率化学部', '実践応用学部', 'キャッチアップ学部', 'ビジネスAI学部', 'データサイエンス学部', 'AI開発学部'],
      recommended: true,
      isFree: false
    }
  ]
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="mb-8 flex-grow">
                ...
                {/* Departments */}
                <div className="mb-6">
                  <h4 className="font-semibold text-gray-900 mb-3">アクセス可能な学部：</h4>
